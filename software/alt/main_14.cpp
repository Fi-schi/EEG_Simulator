...
String processFileAndGetResult(const String &content, const String &channel);
String processChannelsJson(const String &channelsJson);
    ...
    for (JsonObject elem : channelsArray) {
      ...
      if (SPIFFS.exists(filePath)) {
        ...
        if (file) {
          ...
          file.close();
          // Verarbeite Dateiinhalt: extrahiere Ziffern
...
String processSingleFile(const String &content, const String &channel) {
  // Diese Funktion wird aktuell nicht mehr direkt genutzt.
